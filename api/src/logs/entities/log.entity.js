...
const database_name_1 = require("../../configs/database_name");
let Log = class Log {
    id;
    user;
    action;
...
__decorate([
    (0, typeorm_1.ManyToOne)(() => user_entity_1.User, user => user.logs, { nullable: false }),
...
exports.Log = Log = __decorate([
    (0, typeorm_1.Entity)({ name: `${database_name_1.table.log}` })
], Log);
